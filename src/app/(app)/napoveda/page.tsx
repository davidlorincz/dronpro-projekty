    ...
    <div className="max-w-3xl space-y-6 text-sm text-a-text-2">
      ...
      <section className="card p-5 space-y-2">
        ...
        <ul className="list-disc pl-5 space-y-1">
          ...
          <li><b>Nepřečtené</b> — všude platí stejné pravidlo: <b>tučně s modrou tečkou</b> = přibyly nové zprávy, ale nikdo tě nevolá; <b>červené číslo</b> = týká se to přímo tebe (zmínka, @kanal, přímá zpráva, u Aktivity i odpověď ve vlákně). Ztlumený kanál je šedý a ozve se jen při zmínce. Stav vidíš u konverzace, u položky Chat v hlavním menu (i na tlačítku schovaného menu) a číslo i v titulku záložky. Ve sbalené sekci zůstanou nepřečtené konverzace vidět. Zmizí samo, když konverzaci otevřeš a dojedeš na konec. Filtrem v panelu si necháš jen nepřečtené, tlačítkem vedle označíš vše jako přečtené.</li>
